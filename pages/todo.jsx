    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p className="mt-4">
            This project shows standard To-Do application with data stored in
            local storage. Goal of this project was to practice creating
            reusable components, which makes entire application easier to
