    ...
    <div className="w-full">
      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8">
        <div className="col-span-4">
          ...
          <h2>Overview</h2>
          <p className="mt-4">
            For portfolio project I decided to use Next.js and Tailwind CSS.
            Next.js makes routing within React very simple and Tailwind makes
            CSS very readable and easy to track and edit. Goal was to create
            readable and easy to maintain front-end project. It is deployed on
            Heroku and have CI/CD with GitHub.
          </p>
